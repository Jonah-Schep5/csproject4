...
public class ArithmeticTest extends TestCase {
    ...
    /**
     * Test arithmetic in compareTo (string comparison uses arithmetic
     * internally)
     */
    ...
    public void testBintreeSplittingArithmetic() {
        ...
        assertTrue(result.contains("B1") || result.contains("B2") || result
            .contains("B3") || result.contains("B4"));

        // Test with objects on different sides of split to verify xwid / 2 is
        // used
    ...
    public void testBintreeSubtractionArithmetic() {
        ...
        // Verify objects are correctly placed (proves subtraction arithmetic
        // works)
        String result = tree.print();
        assertNotNull(result);
        assertTrue(result.contains("B1") || result.contains("B2") || result
    ...
    public void testWorldDBArithmetic() {
        ...
        boolean added2 = world.add(new Balloon("B2", 100, 200, 300, 40, 50, 60,
            "hot", 1));
        assertTrue(added2);
    ...
    public void testComplexArithmetic() {
        ...
        // Container: x=100-350 (xwid=250), y=200-450 (ywid=250), z=300-650
        // (zwid=350)
        // Check: 200 >= 100 ✓, 300 <= 350 ✓, 300 >= 200 ✓, 400 <= 450 ✓, 400 >=
        // 300 ✓, 500 <= 650 ✓
    ...
    public void testBintreeWidthArithmetic() {
        ...
        // For region 0-1024: leftXwid = 1024/2 = 512, rightXwid = 1024 - 512 =
        // 512
        Balloon b1 = new Balloon("B1", 100, 100, 100, 50, 50, 50, "hot", 1);
        Balloon b2 = new Balloon("B2", 200, 100, 100, 50, 50, 50, "hot", 1);
        Balloon b3 = new Balloon("B3", 300, 100, 100, 50, 50, 50, "hot", 1);
    ...
    public void testBintreeDepthArithmetic() {
        ...
        for (int i = 0; i < 25; i++) {
            Balloon b = new Balloon("B" + i, (i % 5) * 100, ((i / 5) % 5) * 100,
                (i / 25) * 100, 50, 50, 50, "hot", 1);
            tree.insert(b);
        }
    ...
    public void testBintreeModuloArithmetic() {
        ...
        for (int i = 0; i < 30; i++) {
            Balloon b = new Balloon("B" + i, (i % 8) * 50, ((i / 8) % 8) * 50,
                (i / 64) * 50, 40, 40, 40, "hot", 1);
            tree.insert(b);
        }
